package vn.hoangtojava.configuration;
...
public class LocaleResolver extends AcceptHeaderLocaleResolver implements WebMvcConfigurer {
    ...
    public Locale resolveLocale(HttpServletRequest request) {
        ...
        return StringUtils.hasLength(languageHeader) ? Locale.lookup(Locale.LanguageRange.parse(languageHeader),
                List.of(new Locale("fr"), new Locale("en"), new Locale("vi"))) :Locale.getDefault();
    }

    @Bean
    public ResourceBundleMessageSource bundleELResolver() {
